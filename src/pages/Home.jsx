...
export default function Home() {
  ...
  return (
    <div className="container">
      <div className="hero">
        <img src="/logo.png" alt="Pick&Go" className="hero-logo" style={{width:110,height:110,borderRadius:22}} />
        <h1>Pick&amp;Go Prode</h1>
        ...
        {user ? (
          ...
          <div style={{display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap'}}>
            <Link to="/registro" className="btn btn-gold" style={{fontSize:15,padding:'12px 30px',fontWeight:700}}>
              Crear cuenta gratis
            </Link>
            <Link to="/login" className="btn" style={{background:'rgba(255,255,255,0.2)',color:'white',border:'2px solid rgba(255,255,255,0.5)',fontSize:15,padding:'12px 30px',fontWeight:600}}>
              Ingresar
            </Link>
          </div>
        )}
